...
CREATE POLICY admin_all_access ON closed_periods AS PERMISSIVE FOR ALL USING (is_claims_admin ())
WITH
...
CREATE POLICY user_read_only ON closed_periods AS PERMISSIVE FOR
SELECT
    USING (true);